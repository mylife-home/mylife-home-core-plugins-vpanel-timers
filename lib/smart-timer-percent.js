...
module.exports = class SmartTimerPercent {
  constructor(config) {
    this.initProgram = new PercentProgram(config.initProgram, false);
    this.triggerProgram = new PercentProgram(config.triggerProgram, true);
    this.cancelProgram = new PercentProgram(config.cancelProgram, false);
